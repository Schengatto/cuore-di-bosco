<template>
  <div>
    ...
    <section class="text-center">
      <p>
        A pochi minuti da Brentonico, <strong>Prada</strong> è una piccola
      ...
      <p>
        In inverno si raggiungono le <strong>località scistiche</strong> di
        <strong>Polsa</strong> (10 minuti), <strong>San Giacomo</strong> (15
        minuti) e <strong>San Valentino</strong>
      ...
      <p>
        ...
        cultura e gusto si incontrano. <br />In struttura troverete un display
        con mappe e materiale informativo e in nostri consigli, per ogni
        informazione e materiale è possibile visitare il sito
        <a href="https://www.visitrovereto.it" target="_blank"
          rel="noopener noreferrer nofollow">www.visitrovereto.it</a>
        e l’accogliente punto di informazioni turistiche accanto al comune di
        Brentonico, proprio accanto ad un ampio e curato parco giochi e la
        piazza alberata principale del paese,
    ...
    <section class="text-center">
      ...
      <p>
        È la prima montagna che incontri arrivando in Trentino. Qui puoi fare
        trekking e mountain bike d’estate e sciare sulle piste di Polsa, San
        Valentino e San Giacomo d’inverno.
      </p>
      <p>
        Sei sul versante Trentino del Monte Baldo, fra l’Adige ed il Garda, nel
        cuore del&nbsp;<a href="https://www.visitrovereto.it/scopri/territorio/parco-naturale-locale-del-monte-baldo/"
          target="_blank" rel="noopener noreferrer nofollow">Parco del Monte Baldo</a>&nbsp;conosciuto dai botanici di
        tutta Europa come “Giardino d’Italia”
        per la sua ricchezza di piante e fiori rari.
      </p>
      <p>
        Brentonico è il nome della frazione capoluogo ed il suo comune comprende
        ulteriori frazioni e località montane: Castione, Cazzano, Crosano,
        Cornè, Prada, Saccone e Sorne, così come i centri turistici di San
        Giacomo, San Valentino e Polsa.
      </p>
      <p>
        Al giardino botanico di&nbsp;<a href="http://www.visitrovereto.it/scopri/palazzi/palazzo-eccheli-baisi/"
          target="_blank" rel="noopener noreferrer nofollow">Palazzo Eccheli-Baisi</a>&nbsp;troverai raccolte molte
        delle 1.655 piante del Parco del Monte
        Baldo, la maggioranza di quelle presenti sulle Alpi. Lo apprezzerai al
        meglio con una visita guidata, che ti illustrerà anche le mostre del
        palazzo e il&nbsp;<strong>Museo del fossile</strong>.&nbsp;Ascolta il
        silenzio nell’antica&nbsp;<a
        ...
        secolari ippocastani del parco Cesare
        Battisti,&nbsp;al centro del paese. In località Sorne, scopri il&nbsp;<a
    ...
    <section>
      ...
      <p>
        ...
        i numerosi&nbsp;<strong>itinerari panoramici</strong>&nbsp;scegliendo
        quello più adatto alle tue capacità, come l’itinerario che parte da
        Polsa, prosegue fino a Bocca d’Ardole, al Corno della Paura e raggiunge
        il&nbsp;<a
    ...
    <section>
      ...
      <p>
        L’altopiano di Brentonico è inoltre sede di&nbsp;<a
          ...
          estivi</a>&nbsp;per ragazzi e punto di riferimento per la preparazione atletica
        di squadre di calcio professionistiche e delle nazionali azzurre e
        tedesche di sci.
      </p>
      <p>
        In agosto non perderti il festival&nbsp;<a
    ...
    <section>
      ...
      <p>
        ...
        famose&nbsp;<strong>castagne di Castione</strong>&nbsp;diventano le
        protagoniste indiscusse degli eventi locali, come la&nbsp;<a
        ...
        piatti tipici della
        tradizione trentina: canederli, strangolapreti, polenta di patate, che
        potrai accompagnare con gustosi formaggi, strudel e zelten.
      </p>
    </section>
    ...
    <section>
      ...
      <p>
        ...
        pianura: potrai sciare in
        totale sicurezza e tranquillità su piste ampie e soleggiate. Lo sci non
        è il tuo sport? Scegli fra altre&nbsp;<a href="https://www.visitrovereto.it/info/guide/inverno-sul-monte-baldo/"
          target="_blank" rel="noopener noreferrer nofollow"><strong>attività dell’inverno</strong></a>: ciaspole,
        pattinaggio sul ghiaccio, parco giochi sulla neve o
        slittino! Imperdibile la fiaccolata notturna e gli eventi sulla neve per
        tutti!
      </p>
      <p>
    ...
    <section class="text-center footer">
      <p>
        <strong>Per scoprire tutti gli eventi in corso ti consigliamo il sito
          <a href="https://www.visitrovereto.it" target="_blank">www.visitrovereto.it</a>
          e l’<a href="https://www.visitrovereto.it/info/uffici-turistici-rovereto-vallagarina/">apt di Brentonico</a>,
          inoltre troverai un display in struttura con mappe e depliant
          aggiornati della zona a tua disposizione!</strong>
      </p>
      <p>
        <strong>FONTE TESTO
          <a href="https://www.visitrovereto.it" target="_blank">WWW.VISITROVERETO.IT</a></strong>
      </p>
    </section>
  </div>
</template>
